...
from model_decoding_raw_try_another_model import BrainTranslator
    ...
    with open(output_all_results_path, 'w') as f:
        for _, seq_len, input_masks, input_mask_invert, target_ids, target_mask, sentiment_labels, sent_level_EEG, input_raw_embeddings, input_raw_embeddings_lengths, word_contents, word_contents_attn, subject_batch in dataloaders['test']:
            ...
            seq2seqLMoutput = model(
                input_embeddings_batch, input_masks_batch, input_mask_invert_batch, target_ids_batch, 
                input_embeddings_lengths_batch, word_contents_batch, word_contents_attn_batch, False, subject_batch, device)
...
if __name__ == '__main__': 
    ...
    pretrained_xlnet = XLNetLMHeadModel.from_pretrained('xlnet-base-cased')
    
    if model_name == 'BrainTranslator':
        model = BrainTranslator(pretrained_xlnet, in_feature=1024, decoder_embedding_size=768,

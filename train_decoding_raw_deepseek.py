...
if __name__ == '__main__':
    ...
    if model_name in ['BrainTranslator', 'BrainTranslatorNaive']:
        tokenizer = AutoTokenizer.from_pretrained("deepseek-ai/deepseek-v2-7b-base")
    ...
    if model_name == 'BrainTranslator':
        pretrained =AutoModelForCausalLM.from_pretrained("deepseek-ai/deepseek-v2-7b-base",trust_remote_code=True,torch_dtype=torch.bfloat16)

...
from transformers import AutoTokenizer, AutoModelForCausalLM  # Changed for DeepSeek
...
if __name__ == '__main__':
    ...
    if model_name in ['BrainTranslator', 'BrainTranslatorNaive']:
        tokenizer = AutoTokenizer.from_pretrained(""deepseek-ai/deepseek-llm-1.3b-chat"")
    ...
    if model_name == 'BrainTranslator':
        pretrained =AutoModelForCausalLM.from_pretrained(""deepseek-ai/deepseek-llm-1.3b-chat"",device_map="auto",trust_remote_code=True,torch_dtype=torch.bfloat16)
    ...
    if skip_step_one:
        if load_step1_checkpoint:
            stepone_checkpoint = '/kaggle/input/try-enhancement-gans-with-time-wrap/checkpoints/decoding_raw/best/task1_task2_taskNRv2_finetune_BrainTranslator_2steptraining_b20_10_10_5e-05_5e-05_unique_sent.pt'

...
if __name__ == '__main__':
    ...
    if skip_step_one:
        if load_step1_checkpoint:
            stepone_checkpoint = '/kaggle/input/xlnet-batch-20-step2-second/checkpoints/decoding_raw/best/task1_task2_taskNRv2_finetune_BrainTranslator_skipstep1_b20_5_10_5e-05_5e-05_unique_sent.pt'

...
import sys
sys.path.insert(1, '/kaggle/working/EEG-to-Text-Decoding/data_raw_bart_augment.py')
...
if __name__ == '__main__':
    ...
    # train dataset
    train_set = data_raw_bart_augment.ZuCo_dataset(whole_dataset_dicts, 'train', tokenizer, subject=subject_choice,
                             eeg_type=eeg_type_choice, bands=bands_choice, setting=dataset_setting, raweeg=True, use_augmentation=True, num_augmentations=1 )
    # dev dataset
    dev_set = data_raw_bart_augment.ZuCo_dataset(whole_dataset_dicts, 'dev', tokenizer, subject=subject_choice,
                           eeg_type=eeg_type_choice, bands=bands_choice, setting=dataset_setting, raweeg=True)
    # test dataset
    test_set = data_raw_bart_augment.ZuCo_dataset(whole_dataset_dicts, 'test', tokenizer, subject=subject_choice,
                            eeg_type=eeg_type_choice, bands=bands_choice, setting=dataset_setting, raweeg=True)

...
sys.path.insert(1, '/kaggle/working/EEG-to-Text-Decoding/model_decoding_raw_gpt2_bart.py')
...
import data_raw
import config
import model_decoding_raw_gpt2_bart
...
if __name__ == '__main__':
    ...
    if model_name == 'BrainTranslator':
        ...
        model = model_decoding_raw_gpt2_bart.BrainTranslator(pretrained, in_feature=1024, decoder_embedding_size=1024,
